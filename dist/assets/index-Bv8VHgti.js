(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();const va="modulepreload",ma=function(e){return"/"+e},rt={},Q=function(i,t,n){let s=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),l=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=Promise.allSettled(t.map(d=>{if(d=ma(d),d in rt)return;rt[d]=!0;const v=d.endsWith(".css"),u=v?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const g=document.createElement("link");if(g.rel=v?"stylesheet":va,v||(g.as="script"),g.crossOrigin="",g.href=d,l&&g.setAttribute("nonce",l),document.head.appendChild(g),v)return new Promise((f,E)=>{g.addEventListener("load",f),g.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return s.then(r=>{for(const l of r||[])l.status==="rejected"&&a(l.reason);return i().catch(a)})},me={location:null,powerSource:null,tariffBand:null,gridSpend:1e5,fuelSpend:5e4,generatorSize:null,houseType:null,rooms:0,appliances:[],solarAppliances:null,customSchedule:null,goal:null,backupHours:4,budget:15e5,results:null,_data:{}},ga=new Set;function R(){return{...me}}function D(e){Object.assign(me,e),ga.forEach(i=>i({...me}))}function z(e){return me._data[e]||null}function ee(e,i){me._data[e]=i}const ya=['<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"/></svg>','<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M13 2L4.09 12.33A1 1 0 005 14h7l-1 8 8.91-10.33A1 1 0 0019 10h-7l1-8z"/></svg>','<svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><circle cx="11" cy="11" r="4"/><line x1="21" y1="3" x2="14.35" y2="9.65"/><polyline points="17,3 21,3 21,7"/></svg>'],lt=[[1],[2],[3]],ha=["step1","step2","step3"];function Ke(e){const i=lt.findIndex(t=>t.includes(e));return`
  ...
  `}function Tt(e,i){var l,d,v;const t=R(),n=z("pv_yield")||[];e.innerHTML=`
  ...
  `;const s=document.getElementById("location-select"),a=document.getElementById("continue-btn"),r=document.getElementById("location-info");s.addEventListener("change",()=>{const u=n.find(g=>g.state===s.value);u?(D({location:u}),document.getElementById("loc-zone").textContent=u.zone,document.getElementById("loc-psh").textContent=`${u.daily_yield_kwh_per_kwp} hrs/day`,document.getElementById("loc-yield").textContent=`${u.annual_yield_kwh_per_kwp} kWh/kWp`,r.style.display="block",a.disabled=!1):(D({location:null}),r.style.display="none",a.disabled=!0)}),a.addEventListener("click",()=>{R().location&&i("step2")})}function Ee(e){return"₦"+Number(e).toLocaleString("en-NG")}function ct(e){return parseInt(String(e).replace(/[₦,\s]/g,""),10)||0}function Bt(e){return(14-e/100*28).toFixed(1)}function dt({id:e,value:i,min:t,max:n,step:s=1e3,ticks:a,label:r="per month",formatFn:l=Ee}){const d=(i-t)/(n-t)*100,v=Bt(d),u=a?a.map((g,f)=>{const E=(g-t)/(n-t)*100,c=i>=(f===0?t:a[f-1])&&i<=g,o=f===0?"translateX(0)":f===a.length-1?"translateX(-100%)":"translateX(-50%)";return`<span class="slider-tick ${c?"active":""}" data-val="${g}" style="left:${E}%;transform:${o}">${l(g)}</span>`}).join(""):"";return`
    <div class="slider-wrapper">
      ...
      <div class="slider-track-wrap">
        <div class="slider-tooltip" id="${e}-tooltip" style="left:calc(${d}% + ${v}px)">
          <span class="slider-tooltip__val">${l(i)}</span>
  ...
  `}function pt(e,i=Ee,t){const n=document.getElementById(e),s=document.getElementById(`${e}-val`),a=document.getElementById(`${e}-tooltip`);if(!n||!s)return;const r=Number(n.min),l=Number(n.max),d=Number(n.step)||1;function v(){const u=Number(n.value),g=(u-r)/(l-r)*100,f=Bt(g);if(n.style.background=`linear-gradient(to right, var(--color-primary) ${g}%, var(--color-border) ${g}%)`,s.value=i(u),a){a.style.left=`calc(${g}% + ${f}px)`;const c=a.querySelector(".slider-tooltip__val");c&&(c.textContent=i(u))}t&&t(u);const E=n.closest(".slider-track-wrap").querySelectorAll(".slider-tick");if(E.length>0){const c=Array.from(E).map(o=>Number(o.dataset.val));E.forEach((o,p)=>{const _=p===0?r:c[p-1];o.classList.toggle("active",u>=_&&u<=c[p])})}}if(n.addEventListener("input",v),n.addEventListener("change",v),s.addEventListener("focus",()=>{s.value=ct(s.value)||"",s.select()}),s.addEventListener("blur",()=>{const u=ct(s.value),g=Math.max(r,Math.min(l,u||r)),f=Math.round((g-r)/d)*d+r;n.value=f,v()}),s.addEventListener("keydown",u=>{u.key==="Enter"&&s.blur()}),a){const u=()=>a.classList.add("visible"),g=()=>a.classList.remove("visible");n.addEventListener("mousedown",u),n.addEventListener("touchstart",u,{passive:!0}),document.addEventListener("mouseup",g),document.addEventListener("touchend",g)}}function De({cards:e,selected:i,name:t}){return`
  ...
  `}function je(e,i){const t=document.querySelector(`[data-radio-group="${e}"]`);t&&t.querySelectorAll(".radio-card").forEach(n=>{n.addEventListener("click",()=>{t.querySelectorAll(".radio-card").forEach(s=>s.classList.remove("selected")),n.classList.add("selected"),i&&i(n.dataset.value)})})}const fa='<img src="/icons/grid_only.png" width="72" height="72" style="object-fit:contain">',ba='<img src="/icons/generator_only.png" width="72" height="72" style="object-fit:contain">',ka='<img src="/icons/grid_and_generator.png" width="72" height="72" style="object-fit:contain">',xa='<img src="/icons/small_generator_i_better_pass_my_neighbour.png" width="72" height="72" style="object-fit:contain">',_a='<img src="/icons/medium_generator.png" width="72" height="72" style="object-fit:contain">',wa='<img src="/icons/silent_diesel_generator.png" width="72" height="72" style="object-fit:contain">',Sa=[{id:"grid_only",emoji:fa,name:"Grid Only",desc:"I rely solely on NEPA/DisCo grid supply"},{id:"both",emoji:ka,name:"Grid + Generator",desc:"I use both grid and a backup generator"},{id:"generator_only",emoji:ba,name:"Generator Only",desc:"No grid, I run a generator for power"}],Ea=[{id:"small",emoji:xa,label:"I better pass my neighbour",name:"Small (1–2 KVA)"},{id:"medium",emoji:_a,label:"Gasoline generator",name:"Medium (3–5 KVA)"},{id:"large",emoji:wa,label:"Silent diesel generator",name:"Large (6–10 KVA)"}];function Rt(e,i){function t(){var v,u;const s=R(),a=z("tariff_bands")||[],r=s.powerSource==="grid_only"||s.powerSource==="both",l=s.powerSource==="generator_only"||s.powerSource==="both",d=s.powerSource&&(!r||!!s.tariffBand)&&(!l||!!s.generatorSize);e.innerHTML=`
        ...
        <div class="step-body">
          ...
          ${r?`
            ...
            <div class="tariff-pills" id="tariff-pills">
              ${a.map(g=>`
                <button class="tariff-pill ${s.tariffBand===g.band?"selected":""}" data-band="${g.band}">${g.band}</button>
              `).join("")}
            </div>
            ${s.tariffBand?`
              <div class="card" style="margin-top:10px;margin-bottom:16px;background:var(--color-primary-bg);border-color:var(--color-primary-light);padding:10px 14px">
                <div style="display:flex;align-items:center;gap:14px">
                  ...
                  <div style="font-size:12px;color:var(--color-text-secondary)">
                    ${((v=a.find(g=>g.band===s.tariffBand))==null?void 0:v.hours_of_supply)||""} hrs/day
                    &nbsp;·&nbsp; ₦${((u=a.find(g=>g.band===s.tariffBand))==null?void 0:u.tariff_naira_per_kwh)||""}/kWh
    ...
    `,n()}function n(){document.getElementById("back-btn").addEventListener("click",()=>i("step1")),document.getElementById("continue-btn").addEventListener("click",()=>i("step3")),je("power-source",s=>{D({powerSource:s}),t()}),document.querySelectorAll(".tariff-pill").forEach(s=>{s.addEventListener("click",()=>{D({tariffBand:s.dataset.band}),t()})}),je("gen-size",s=>{D({generatorSize:s}),t()}),document.getElementById("grid-spend-slider")&&pt("grid-spend-slider",Ee,s=>D({gridSpend:s})),document.getElementById("fuel-spend-slider")&&pt("fuel-spend-slider",Ee,s=>D({fuelSpend:s}))}t()}const ut=["Analysing your energy profile","Sizing your solar PV system","Calculating your savings with solar","Finalising your results"],Aa=[{activeAt:0,doneAt:3e3},{activeAt:3e3,doneAt:8e3},{activeAt:8e3,doneAt:15e3},{activeAt:15e3,doneAt:18e3}],$a=18e3,La=`
#preloader-overlay {
  position: fixed;
  inset: 0;
  background: #ffffff;
...
`;function Ca(){if(document.getElementById("pl-styles"))return;const e=document.createElement("style");e.id="pl-styles",e.textContent=La,document.head.appendChild(e)}function Ma(e){Ca();const i=document.createElement("div");i.id="preloader-overlay",i.innerHTML=`
  ...
  `,document.getElementById("back-btn").addEventListener("click",()=>i("step2"));function n(){var r;(r=document.querySelector(".backup-hours-inject"))==null||r.remove();const s=document.querySelector('[data-radio-group="solar-goal"] [data-value="backup"]');if(!s)return;const a=document.createElement("div");a.className="backup-hours-inject",a.style.cssText="margin-top:12px;padding-top:12px;border-top:1.5px solid rgba(0,0,0,0.12);display:flex;justify-content:center",a.innerHTML=`
      ...
      </div>`,s.appendChild(a),document.getElementById("backup-dec").addEventListener("click",l=>{l.stopPropagation(),D({backupHours:Math.max(1,R().backupHours-1)}),document.getElementById("backup-val").textContent=R().backupHours}),document.getElementById("backup-inc").addEventListener("click",l=>{l.stopPropagation(),D({backupHours:R().backupHours+1}),document.getElementById("backup-val").textContent=R().backupHours})}je("solar-goal",s=>{var a;D({goal:s}),document.getElementById("generate-btn").disabled=!1,s==="backup"?n():(a=document.querySelector(".backup-hours-inject"))==null||a.remove()}),R().goal==="backup"&&n(),document.getElementById("generate-btn").addEventListener("click",()=>{Ce(),Ma(()=>i("costSavings"))})}const xt=e=>"₦"+Number(e).toLocaleString("en-NG"),ri=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],li={north:[.6,.8,1.3,1.45,1.3,.85,.7,.72,.9,1.1,.75,.6],middle:[.75,.9,1.25,1.35,1.15,.82,.68,.7,.85,1.05,.85,.72],south:[1.1,1.2,1.3,1.2,1,.7,.65,.65,.8,1,1.1,1.05]};function Gt(e){return e?/North West|North East/i.test(e)?"north":/North Central/i.test(e)?"middle":"south":"south"}function ci(e,i,t,n){const s={};(t||[]).forEach(c=>{s[c.name]=c});let a=0,r=0;(i||[]).forEach(c=>{const o=s[c.name];if(!o)return;const p=o.rated_watts*(c.qty||1);r+=p,o.category==="Cooling"&&(a+=p)});const l=r>0?a/r:.35,d=li[Gt(n)],v=d.reduce((c,o)=>c+o,0)/12,u=d.map(c=>c/v),g=e.totalDailyKWh,f=g*l,E=g-f;return u.map(c=>parseFloat(((E+f*c)*30).toFixed(1)))}function Dt(e,i){const t=R(),n=z("appliances")||[],{results:s,location:a,powerSource:r,tariffBand:l,gridSpend:d,fuelSpend:v,appliances:u}=t;if(!s){i("step1");return}const{load:g,solar:f}=s,E=u&&u.length>0,c={grid_only:"Grid Only",generator_only:"Generator Only",both:"Grid & Generator"}[r]||"Grid & Generator",o={};n.forEach(w=>{o[w.name]=w});let p=0,_=0;(u||[]).forEach(w=>{const C=o[w.name];if(!C)return;const L=C.rated_watts*(w.qty||1);_+=L,C.category==="Cooling"&&(p+=L)});const A=_>0?Math.round(p/_*100):35,S=(a==null?void 0:a.zone)||"",M=Gt(S),k={north:"Northern Nigeria: peak cooling March to May, cool harmattan Nov to Feb",middle:"Middle Belt: peak cooling March to May, mild rainy dip Jun to Sep",south:"Southern Nigeria: peak cooling Feb to Apr, rainy season dip Jun to Sep"}[M],y=E?`
    <div class="card">
  ...
  `,window._navigate=i,document.querySelectorAll(".confidence-tooltip-wrap").forEach(k=>{var y;(y=k.querySelector(".confidence-tooltip-btn"))==null||y.addEventListener("click",m=>{m.stopPropagation();const b=k.classList.contains("is-open");document.querySelectorAll(".confidence-tooltip-wrap.is-open").forEach(w=>w.classList.remove("is-open")),b||k.classList.add("is-open")})}),document.addEventListener("click",()=>{document.querySelectorAll(".confidence-tooltip-wrap.is-open").forEach(k=>k.classList.remove("is-open"))}),St(p,d),v&&(yi(o.confidenceScore),document.getElementById("spec-confidence-prompt").innerHTML=gi(o.confidenceReason,o.confidenceLabel,o.confidenceDirection),requestAnimationFrame(()=>{Et("dispatch-canvas",A),wt()})),v&&document.querySelectorAll(".profile-appliance-row[data-name]").forEach(k=>{k.addEventListener("click",()=>{const y=k.dataset.name,m=k.querySelector(".checkbox");E.has(y)?(E.delete(y),m.classList.remove("checked")):(E.add(y),m.classList.add("checked"));const b=E.size===n.length;D({solarAppliances:b?null:[...E]});const w=document.getElementById("solar-selection-indicator");w&&(w.textContent=`(${E.size}/${n.length} selected)`),M()})});function M(){const{solar:k,battery:y,dispatch:m}=c(),b=w=>document.getElementById(w);b("spec-solar-kwp").textContent=`${k.panel_kwp} kWp`,b("spec-solar-count").textContent=`Capacity · ${k.panel_count} panels`,b("spec-inverter-kva").textContent=`${k.inverter_kva} kVA`,b("spec-battery-kwh").textContent=`${y.battery_kwh} kWh`,b("spec-battery-units").textContent=`Storage · ${y.battery_units_48v} units`,b("spec-area-m2").textContent=`${k.installation_m2} m²`,b("spec-annual-gen").textContent=Ge(k.annual_gen_kwh),b("spec-storage-cap")&&(b("spec-storage-cap").textContent=`${y.storage_capacity} kWh`),b("spec-storage-out")&&(b("spec-storage-out").textContent=`${y.storage_output.toFixed(2)} kW`),b("spec-backup-ess")&&(b("spec-backup-ess").textContent=`${y.backup_hours_essentials}hrs`),b("spec-backup-app")&&(b("spec-backup-app").textContent=`${y.backup_hours_appliances}hrs`),b("spec-backup-home")&&(b("spec-backup-home").textContent=`${y.backup_hours_whole_home}hrs`),b("dispatch-stat-reliance")&&(b("dispatch-stat-reliance").innerHTML=`${g} <strong>${Math.round(m.gridReliance_before*100)}% → ${Math.round(m.gridReliance_after*100)}%</strong>`),b("dispatch-stat-grid")&&(b("dispatch-stat-grid").innerHTML=`Avg daily grid use <strong>${m.totalDemand.toFixed(1)} → ${m.avgDailyGridKWh} kWh</strong>`),b("dispatch-stat-surplus")&&(b("dispatch-stat-surplus").innerHTML=`Avg daily surplus <strong>${m.dailySurplusKWh} kWh</strong>`),St(k,d),v&&(Et("dispatch-canvas",m),requestAnimationFrame(wt)),Ce(),vi()}}function St(e,i){var r;const t=document.getElementById("gen-chart");if(!t)return;(r=Chart.getChart(t))==null||r.destroy();const n=t.getContext("2d"),s=e.monthly_gen.map(l=>l.kwh),a=Math.max(...s);new Chart(n,{type:"bar",data:{labels:i,datasets:[{data:s,backgroundColor:s.map(l=>l/a>.9?"#EF4444":l/a>.75?"#F5A623":"#FCD34D"),borderRadius:8,barPercentage:.5,categoryPercentage:.8}]},options:{responsive:!0,plugins:{legend:{display:!1},tooltip:{callbacks:{label:l=>`${l.raw} kWh`}}},scales:{x:{grid:{display:!1},ticks:{font:{size:9,family:"Outfit, sans-serif"}}},y:{grid:{color:"#F3F4F6"},ticks:{font:{size:9,family:"Outfit, sans-serif"},callback:l=>`${l}`}}}}})}function yi(e){var s;const i=document.getElementById("gauge-chart");if(!i)return;(s=Chart.getChart(i))==null||s.destroy();const t=i.getContext("2d"),n=e>=85?"#10B981":e>=55?"#F59E0B":"#EF4444";new Chart(t,{type:"doughnut",data:{datasets:[{data:[e,100-e],backgroundColor:[n,"#E5E7EB"],borderWidth:0,circumference:180,rotation:270}]},options:{responsive:!1,cutout:"75%",plugins:{legend:{display:!1},tooltip:{enabled:!1}}}})}function Et(e,i){let t=document.getElementById(e);if(!t||!i)return;const n=t.cloneNode(!1);t.parentNode.replaceChild(n,t),t=n;const s=t.parentElement,a=window.devicePixelRatio||1,r=s.clientWidth||Math.min(window.innerWidth-32,600),l=220;t.width=r*a,t.height=l*a,t.style.width=r+"px",t.style.height=l+"px";const d=t.getContext("2d");d.scale(a,a);const v=46,u=12,g=10,f=28,E=r-v-u,c=l-g-f,o=i.hours,_=Math.max(...o.map(C=>C.demand+C.solar_to_charge),.01)*1.12,A=c/_,S=E/24,M=Math.max(4,S*.6),k=5,y={solar:"#FCBF1E",battery:"#2E86AB",grid:"#E84855",charge:"#A8DADC"};d.font="10px Outfit, sans-serif",d.textAlign="right",[0,.25,.5,.75,1].forEach(C=>{const L=_*C,h=g+c-L*A;d.strokeStyle="#F3F4F6",d.lineWidth=1,d.beginPath(),d.moveTo(v,h),d.lineTo(v+E,h),d.stroke(),d.fillStyle="#9CA3AF",d.fillText(L.toFixed(1),v-4,h+3.5)}),d.save(),d.translate(13,g+c/2),d.rotate(-Math.PI/2),d.textAlign="center",d.fillStyle="#6B7280",d.fillText("kW",0,0),d.restore();function m(C,L,h,$,F){if($<=0)return;const T=Math.min(F,h/2,$/2);d.beginPath(),d.moveTo(C,L+$),d.lineTo(C,L+T),d.quadraticCurveTo(C,L,C+T,L),d.lineTo(C+h-T,L),d.quadraticCurveTo(C+h,L,C+h,L+T),d.lineTo(C+h,L+$),d.closePath(),d.fill()}const b=[];o.forEach(C=>{const L=[{v:C.solar_to_load,c:y.solar},{v:C.battery_to_load,c:y.battery},{v:C.grid_to_load,c:y.grid},{v:C.solar_to_charge,c:y.charge}];let h=-1;for(let x=L.length-1;x>=0;x--)if(L[x].v>=.001){h=x;break}const $=v+C.hour*S+(S-M)/2,F=g+c;let T=F;L.forEach((x,B)=>{if(x.v<.001)return;const W=x.v*A;T-=W,d.fillStyle=x.c,B===h?m($,T,M,W,k):d.fillRect($,T,M,W)}),b.push({bx:$,bW:M,topY:T,bottomY:F,d:C})}),d.strokeStyle="#D1D5DB",d.lineWidth=1,d.beginPath(),d.moveTo(v,g+c),d.lineTo(v+E,g+c),d.stroke(),d.fillStyle="#6B7280",d.textAlign="center",d.font="9px Outfit, sans-serif";for(let C=0;C<24;C+=3){const L=C===0?"12am":C<12?`${C}am`:C===12?"12pm":`${C-12}pm`;d.fillText(L,v+C*S+S/2,l-6)}const w=document.getElementById("dispatch-tooltip");t.addEventListener("mousemove",C=>{const L=t.getBoundingClientRect(),h=C.clientX-L.left,$=C.clientY-L.top,F=b.find(W=>h>=W.bx&&h<=W.bx+W.bW);if(!F||$<g||$>g+c){w&&(w.style.display="none");return}const T=F.d,x=T.hour,B=x===0?"12am":x<12?`${x}am`:x===12?"12pm":`${x-12}pm`;if(w){let W=h+14,I=$-106;W+152>r&&(W=h-166),I<0&&(I=$+14),w.style.left=W+"px",w.style.top=I+"px",w.style.display="block",w.innerHTML=`
        ...
        <div><span style="color:${y.grid}">■</span> ${i.gridLabel}: ${T.grid_to_load.toFixed(2)} kW</div>
      ...
      `}}),t.addEventListener("mouseleave",()=>{w&&(w.style.display="none")})}const ae=e=>"₦"+Number(e).toLocaleString("en-NG");function Nt(e,i){const t=R();if(!t.results){i("step1");return}const{savings:n}=t.results;t.appliances&&t.appliances.length>0;const s=a=>`<span class="confidence-tooltip-wrap" style="display:inline-flex;vertical-align:middle;margin-left:4px"><button class="confidence-tooltip-btn" type="button">?</button><span class="confidence-tooltip-box">${a}</span></span>`;e.innerHTML=`
    <div style="padding:40px 40px 60px">
  ...
  `}function xi(){var e;(e=document.getElementById("modal-close-btn"))==null||e.addEventListener("click",Me)}const At=["Work From Home","Office Worker","Night Shift","Stay-at-Home","Student","Weekend"],_i={Cooling:"#3B82F6",Lighting:"#FCBF1E",Kitchen:"#F59E0B",Entertainment:"#8B5CF6","ICT / Office":"#06B6D4",Laundry:"#10B981",Water:"#0EA5E9",Security:"#EF4444"};function wi(e,i){switch(i){case"Cooling":return/fan/i.test(e)?"Ceiling Fan":/\b1hp\b/i.test(e)?"AC – Bedroom":"AC – Living Room";case"Lighting":return"Lighting";case"Entertainment":return"Television";case"ICT / Office":return"Laptop / PC";case"Laundry":return/washing/i.test(e)?"Washing Machine":null;case"Kitchen":return/refrig|freezer/i.test(e)?"Refrigerator":/kettle/i.test(e)?"Electric Kettle":null;case"Water":return/pump/i.test(e)?"Water Pump":null;case"Security":return"Always On";default:return null}}function Si(e){const i=[];let t=!1,n=0;for(let s=0;s<24;s++)e[s]>=.5&&!t?(t=!0,n=s):e[s]<.5&&t&&(i.push({start:n,end:s}),t=!1);return t&&i.push({start:n,end:24}),i.length?i:[{start:8,end:10}]}function $t(e,i,t){if(!t)return[{start:8,end:10}];const n=wi(e,i),s=n&&t.schedule[n];return s?Si(s):[{start:8,end:10}]}function xe(e){return Math.round(e*2)/2}function ue(e){const i=Math.floor(e)%24;return i===0?"12am":i<12?`${i}am`:i===12?"12pm":`${i-12}pm`}const P={active:!1,type:null,rowIdx:null,segIdx:null,startX:null,origStart:null,origEnd:null,trackWidth:null};function Ei(e,i){const t=document.getElementById(e);if(!t)return()=>{};const n=z("usage_patterns")||[];let s=R().usagePattern||At[0];const a=R().customSchedule||[],r=Object.fromEntries(a.map(c=>[c.name,c])),l=n.find(c=>c.pattern===s);let d=i.map(c=>r[c.name]?{...r[c.name],segments:r[c.name].segments.map(o=>({...o}))}:{name:c.name,category:c.category||"",segments:$t(c.name,c.category||"",l)});function v(){D({customSchedule:d.map(c=>({...c,segments:c.segments.map(o=>({...o}))}))})}function u(){const c=t.querySelector(".gantt-body");c&&(c.innerHTML=d.map((o,p)=>{const _=_i[o.category]||"#9CA3AF",A=o.segments.map((S,M)=>{const k=(S.start/24*100).toFixed(3),y=Math.max(.5,(S.end-S.start)/24*100).toFixed(3);return`
      ...
      <div class="gantt-header">
        ...
        <div class="gantt-pattern-row">
          ...
          <select class="gantt-select" id="gantt-pattern-sel">
            ${At.map(c=>`<option value="${c}" ${s===c?"selected":""}>${c}</option>`).join("")}
          </select>
        </div>
      </div>
    ...
    </div>`,document.getElementById("gantt-pattern-sel").addEventListener("change",c=>{s=c.target.value,D({usagePattern:s});const o=n.find(p=>p.pattern===s);d=d.map(p=>({...p,segments:$t(p.name,p.category,o)})),v(),u()}),u(),v(),function(){document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",E)}}const Ne=e=>String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;");function Kt(e){return{Cooling:"❄️",Lighting:"💡",Kitchen:"🍳",Entertainment:"📺","ICT / Office":"💻",Laundry:"🫧",Water:"💧",Security:"🔒"}[e]||"🔌"}function Ai(e,i){const t={};i.forEach(s=>{t[s.name]=s});const n=e.map(s=>{const a=t[s.name],r=a?a.qty:0;return`
...
`,Li={bungalow:9,duplex:14,terrace:20},Lt={"9W":2,"15W":1};function Ci(e,i,t){const n=(t[e]||[]).filter(a=>!a.name.startsWith("LED Bulb")),s=i&&i>0?i:Li[e]||9;return[...n,{name:"LED Bulb (9W)",qty:s*Lt["9W"]},{name:"LED Bulb (15W)",qty:s*Lt["15W"]}]}function Mi(e,i){const t=z("appliances")||[],n=z("house_type_appliances")||{};let s=null;const a=[{id:"bungalow",emoji:'<img src="/icons/bungalow.png" width="72" height="72" style="object-fit:contain">',name:"Bungalow"},{id:"duplex",emoji:'<img src="/icons/duplex_home_type.png" width="72" height="72" style="object-fit:contain">',name:"Duplex"},{id:"terrace",emoji:'<img src="/icons/terrace_house_type.png" width="72" height="72" style="object-fit:contain">',name:"Terrace House"}];function r(){s&&(s(),s=null);const c=R();e.innerHTML=`
  ...
  `}function hs(){const e=q.shortlist;if(e.length===0)return"";const i=ye(ge),t=e.map(s=>i.find(a=>a.id===s)).filter(Boolean),n=e.length<2?"Add one more to compare side by side":e.length>=4?"Maximum 4 quotes reached":"Ready to compare side by side";return`
              ...
              <div class="sf-review-card">
                <div class="sf-review-top">
                  <div style="display:flex;align-items:center;gap:10px">
                    <div class="sf-review-avatar" style="background:${s[o%3]}">${c.name[0]}</div>
                    <div>
  ...
  `,(S=N.querySelector("#fc-mode-switch"))==null||S.addEventListener("click",()=>{O.fundMode=i?"self":"loan",Z()}),N.querySelectorAll("[data-mode]").forEach(y=>{y.addEventListener("click",()=>{O.fundMode=y.dataset.mode,Z()})}),i){const y=N.querySelector("#fc-range");y.addEventListener("input",()=>{const m=parseInt(y.value);O.down=m;const b=(m-10)/40*100;y.style.background=`linear-gradient(to right, #FCBF1E 0%, #FCBF1E ${b}%, #E5E7EB ${b}%, #E5E7EB 100%)`;const w=N.querySelector("#fc-down-pct");w&&(w.textContent=`${m}%`);const C=ve(),L=N.querySelector("#fc-down-row");L&&(L.innerHTML=`<span>You pay now: <strong>${G(C*m/100)}</strong></span><span>To finance: <strong>${G(C*(1-m/100))}</strong></span>`)}),y.addEventListener("change",()=>Z()),N.querySelectorAll("[data-tenure]").forEach(m=>{m.addEventListener("click",()=>{O.tenure=parseInt(m.dataset.tenure),Z()})}),N.querySelectorAll("[data-bank]").forEach(m=>{m.addEventListener("click",()=>{const b=s.find(w=>w.id===m.dataset.bank);b&&Ss(b,n,t)})})}else(M=N.querySelector('[data-bank="self"]'))==null||M.addEventListener("click",()=>{O.picked={id:"self",name:"self-fund",isSelf:!0,monthly:0,total:ve(),approval:"N/A"},O.view="done",Z()});(k=N.querySelector("#fc-back"))==null||k.addEventListener("click",()=>Ve("compare"))}function Ss(e,i,t){var r,l,d;const n=ve(),s=Y,a=document.createElement("div");a.id="fc-modal-overlay",a.innerHTML=`
    <div class="fc-modal">
      ...
      ${s?`<div class="fc-modal-installer">
        ...
        <span style="font-size:13px;font-weight:600;color:var(--color-text)">${s.name} · ${((d=(l=(r=R().results)==null?void 0:r.solar)==null?void 0:l.panel_kwp)==null?void 0:d.toFixed(2))??"—"} kWp system</span>
      </div>`:""}
        ...
        <table class="cq-table">
          <thead>
            <tr>
              ...
              ${n.map(o=>{var _;const p=$s((_=R().location)==null?void 0:_.state).installerAreas[o.id]||o.district;return`
                <th class="cq-th ${o.id===s?"cq-th--best":""}">
                  <div class="cq-th-logo">${o.init}</div>
                  <div class="cq-th-name">${o.name}</div>
                  <div class="cq-th-district">${p}</div>
                  ${o.id===s?'<div class="cq-best-chip">★ BEST VALUE</div>':""}
          ...
          <tbody>
            ${Ms.map((o,p)=>{const _=p%2===0,A=_?"#F2F3F2":"#FFFFFF",S="#FEF0C0",M="#FEF8E0";return`
              <tr>
                <td class="cq-col-label" style="background:${A}">${o.label}</td>
                ${n.map(k=>{var w;const y=o.bestFn&&((w=o.bestFn(n))==null?void 0:w.id)===k.id,m=k.id===s?_?S:M:A;return`<td class="${`cq-td ${k.id===s?"cq-td--best":""}`}" style="background:${m}">
            ...
            <tr>
              ...
              ${n.map(o=>`
                <td class="cq-td-footer ${o.id===s?"cq-td--best":""}">
                  <button class="cq-finance-btn ${o.id===s?"best":""}" data-finance="${o.id}">Finance this</button>
                </td>
              `).join("")}
  ...
  `,Nt(document.getElementById("section-costSavings"),U),Dt(document.getElementById("section-loadProfile"),U),jt(document.getElementById("section-solarPVSystem"),U),zt(document.getElementById("section-finalQuote"),U),ie=Is(),e&&requestAnimationFrame(()=>Zt(e))}function Xt(){const e=document.getElementById("results-content");if(e&&e.scrollHeight>e.clientHeight)return e;const i=document.querySelector(".right-panel");return i&&i.scrollHeight>i.clientHeight?i:null}function Zt(e){const i=document.getElementById(`section-${e}`);if(!i)return;const t=Xt();if(t){const n=t.getBoundingClientRect(),s=i.getBoundingClientRect();t.scrollTo({top:t.scrollTop+s.top-n.top,behavior:"smooth"})}else i.scrollIntoView({behavior:"smooth",block:"start"})}function Is(){const e=Xt(),i=e||window;function t(){const n=e?e.clientHeight:window.innerHeight,a=(e?e.getBoundingClientRect().top:0)+n*.3;let r=Le[0];for(const l of Le){const d=document.getElementById(`section-${l}`);d&&d.getBoundingClientRect().top<=a&&(r=l)}r!==V&&(V=r,Qt(r))}return i.addEventListener("scroll",t,{passive:!0}),()=>i.removeEventListener("scroll",t)}function Qt(e){document.querySelectorAll("#results-nav [data-route]").forEach(i=>{i.classList.toggle("active",i.dataset.route===e)})}function ea(){const e=document.getElementById("wizard-layout"),i=document.getElementById("results-layout");if(ie&&(ie(),ie=null),Ts.includes(V)){e.classList.remove("hidden"),i.classList.add("hidden");const t=document.getElementById("wizard-content");t.innerHTML="",{step1:Tt,step2:Rt,step3:Ot}[V](t,U),document.querySelector(".right-panel").scrollTop=0}else if(["addAppliances","market","compare","financing"].includes(V)){e.classList.add("hidden"),i.classList.remove("hidden"),ta(),aa();const t=document.getElementById("results-content");t.innerHTML="",Rs[V](t,U),requestAnimationFrame(()=>{t.scrollTop=0})}}function ta(){var n;const e=document.getElementById("results-nav"),i=document.getElementById("results-actions"),t=V;e.innerHTML=Bs.map(s=>`
  ...
  `).join(""),e.querySelectorAll("[data-route]").forEach(s=>{s.addEventListener("click",()=>U(s.dataset.route))}),i.innerHTML=`
    <button class="btn btn--outline btn--sm btn--full" id="adjust-energy-btn">Adjust Energy Data</button>
  `,(n=document.getElementById("adjust-energy-btn"))==null||n.addEventListener("click",()=>U("step1"))}function aa(){if(Ft)return;Ft=!0;const e=document.getElementById("results-hamburger"),i=document.getElementById("offcanvas-close-btn"),t=document.getElementById("offcanvas-backdrop"),n=document.querySelector(".results-sidebar");function s(){n.classList.add("is-open"),t.classList.add("is-visible")}function a(){n.classList.remove("is-open"),t.classList.remove("is-visible")}e==null||e.addEventListener("click",s),i==null||i.addEventListener("click",a),t==null||t.addEventListener("click",a),n==null||n.addEventListener("click",r=>{r.target.closest("[data-route]")&&a()})}function Ps(){window._navigate=U,document.querySelectorAll(".logo, .mobile-top-bar").forEach(e=>{e.style.cursor="pointer",e.addEventListener("click",()=>U("step1"))}),ea()}async function qs(){const[e,i,t,n,s,a,r]=await Promise.all([Q(()=>import("./pv_yield-zu19S3ka.js"),[]),Q(()=>import("./appliances-By550bug.js"),[]),Q(()=>import("./usage_patterns-BryIkWX-.js"),[]),Q(()=>import("./tariff_bands-C6yWzGBK.js"),[]),Q(()=>import("./fuel_prices-jFU3ASga.js"),[]),Q(()=>import("./generator_efficiency-MkdsxVYB.js"),[]),Q(()=>import("./house_type_appliances-D5Qin5UE.js"),[])]);ee("pv_yield",e.default),ee("appliances",i.default),ee("usage_patterns",t.default),ee("tariff_bands",n.default),ee("fuel_prices",s.default),ee("generator_efficiency",a.default),ee("house_type_appliances",r.default)}async function Os(){await qs(),Ps()}Os();
